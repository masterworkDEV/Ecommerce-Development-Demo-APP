<template>
  ...
  >
    ...
    <div class="flex items-center w-32 h-12 gap-2">
      <div class="bg-white w-20 p-4 flex items-center justify-center max-md:w-10 max-md:p-3">
        <svg
          viewBox="0 0 24 24"
          class="fill-black w-4 h-3/4 max-md:w-3"
          fill="none"
          fill-opacity="1"
          transform="rotate(-45)"
