<template>
  ...
  >
    <header
      class="flex w-full justify-between items-center text-center pt-10 pb-10 px-14 max-xl:px-10 max-md:px-5 max-md:pt-5 max-md:pb-5"
    >
      <!-- menu svg-->
      <nav class="flex justify-center gap-10 items-center text-center max-lg:gap-5">
        ...
        >
          <RouterLink
            :to="{ name: 'home' }"
            class="link max-xl:text-normal font-text"
      ...
      <nav class="flex justify-center items-center text-center gap-10 max-md:gap-2">
...
.nav-bar.nav-active {
  background: #f1f1f1;
  transition: all 0.5s;
  box-shadow: 0px 3px 6px #cccccc86;
}
